...
// #include <cstdint>
#ifdef __RVVF__
#ifndef RAJA_policy_vector_register_rvv_int32_t_HPP
...
class Register<int32_t, rvv_register>
    : public internal::expt::RegisterBase<Register<int32_t, rvv_register>>
{
public:
  using base_type =
      internal::expt::RegisterBase<Register<int32_t, rvv_register>>;

  using register_policy = rvv_register;
  using self_type       = Register<int32_t, rvv_register>;
  using element_type    = int32_t;
  using register_type   = fixed_int32_t;
