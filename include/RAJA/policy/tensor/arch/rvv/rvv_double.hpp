...
// #include <cstdint>
#ifdef __RVVF__
#ifndef RAJA_policy_vector_register_rvv_double_HPP
#define RAJA_policy_vector_register_rvv_double_HPP
...
typedef VTYPE(float64, LMUL) fixed_float64_t __attribute__((riscv_rvv_vector_bits(LMUL * VL)));

template<>
class Register<double, rvv_register>
    : public internal::expt::RegisterBase<Register<double, rvv_register>>
{
public:
  using base_type =
      internal::expt::RegisterBase<Register<double, rvv_register>>;

  using register_policy = rvv_register;
  using self_type       = Register<double, rvv_register>;
  using element_type    = double;
  
  using register_type   = fixed_float64_t;
...
public:
  static constexpr camp::idx_t s_num_elem = VL * LMUL / 64;
  ...
  Register(){
    vl = VSET(64, LMUL)();
    m_value = VOP(vfmv, v_f, f64, LMUL,)((double)0, vl);
  }
   ...
   */
  RAJA_INLINE
  explicit Register(register_type const& c) : m_value(c), vl(VSET(64, LMUL)()) {}

  /*!
   * @brief Copy constructor
   */
  RAJA_INLINE
  Register(self_type const& c) : base_type(c), m_value(c.m_value), vl(VSET(64, LMUL)()) {}
   ...
   */
  RAJA_INLINE
  Register(element_type const& c) : vl(VSET(64, LMUL)()){
    m_value = VOP(vfmv, v_f, f64, LMUL,)((double)c, vl);
  }
...
#endif
    m_value = VOP(vle64, v, f64, LMUL,)(ptr,  vl);
    return *this;
  }
...
#endif
    m_value = VOP(vle64, v, f64, LMUL,_m)(createMask(N), ptr, vl);
    return *this;
  }
...
#endif
    m_value = VOP(vlse64, v, f64, LMUL,)(ptr, stride * sizeof(element_type), vl);
    return *this;
  }
...
#endif
    ptrdiff_t byte_stride = (ptrdiff_t)(stride * sizeof(double));
    m_value = VOP(vlse64, v, f64, LMUL ,_m)(createMask(N), ptr, byte_stride, vl);
    return *this;
  }
  ...
  self_type& gather(element_type const* ptr, int_vector_type offsets)
  {
    ...
    RAJA::tensor_stats::num_vector_load_strided_n++;
#endif
    auto index = VREINTERPRET(i64, u64, LMUL)(offsets.get_register());
    m_value = VOP(vluxei64, v, f64, LMUL, )(ptr, index, vl);
    return *this;
  }
...
#endif 
    auto index = VREINTERPRET(i64, u64, LMUL)(offsets.get_register());
    m_value = VOP(vluxei64, v, f64, LMUL, _m)(createMask(N), ptr, index, vl);
    return *this;
  }
...
#endif
    VOP(vse64, v, f64, LMUL,)(ptr, m_value, vl);
    return *this;
  }
...
#endif
    VOP(vse64, v, f64, LMUL, _m)(createMask(N), ptr, m_value, vl);
    return *this;
  }
...
#endif
    VOP(vsse64, v, f64, LMUL,)(ptr, stride * sizeof(element_type), m_value, vl);
    return *this;
  }
...
#endif
    VOP(vsse64, v, f64, LMUL, _m)(createMask(N), ptr, stride * sizeof(element_type), m_value, vl);
    return *this;
  }
  ...
  { 
    ...
    VOP(vse64, v, f64, LMUL,)(temp, m_value, vl);
    return temp[i];
  }
  ...
  {
    element_type tmp[vl];
    VOP(vse64, v, f64, LMUL,)(tmp, m_value, vl);
    tmp[i] = value;
    m_value = VOP(vle64, v, f64, LMUL, )(tmp, vl);
    return *this;
  }
  ...
  {
    m_value = VOP(vfmv, v_f, f64, LMUL, )(value, vl);
    return *this;
  }
  ...
  self_type get_and_broadcast(int i) const
  {
    ...
    self_type result;
    result.m_value = VOP(vfmv, v_f, f64, LMUL, )(elem, vl);
    return result;
  }
  ...
  {
    return self_type(VOP(vfadd, vv, f64, LMUL,)(m_value, b.m_value, vl));
  }
  ...
  {
    return self_type(VOP(vfsub, vv, f64, LMUL,)(m_value, b.m_value, vl));
  }
  ...
  {
    return self_type(VOP(vfmul, vv, f64, LMUL,)(m_value, b.m_value, vl));
  }
  ...
  {
    return self_type(VOP(vfdiv, vv, f64, LMUL,)(m_value, b.m_value, vl));
  }
  ...
  {
    return self_type(VOP(vfdiv, vv, f64, LMUL, _m)(createMask(N), m_value, b.m_value, vl));
  }
...
// // only use FMA's if the compiler has them turned on
  ...
  {
    return self_type(VOP(vfmadd, vv, f64, LMUL,)(c.m_value, m_value, b.m_value, vl));
  }
  ...
  {
    return self_type(VOP(vfmsub, vv, f64, LMUL,)(c.m_value, m_value, b.m_value, vl));
  }
#endif
  ...
  {
    auto init_scale = VOP(vfmv, v_f, f64, 1,)((double)0, vl);
    auto vsum = VOP(vfredosum, vs, f64, LMUL,_f64m1_m)(createMask(N), m_value, init_scale, vl); 
    element_type result[1];
    VOP(vse64, v, f64, 1, )(result, vsum, vl);
    return result[0];
  }
  ...
  {
    auto e_ = VOP(vfmv, v_f, f64, 1,)(-INFINITY, 1);
    auto vmax = VOP(vfredmax, vs, f64, LMUL, _f64m1_m)(createMask(N), m_value, e_, vl);
    element_type result[1];
    VOP(vse64, v, f64, 1, )(result, vmax, vl);
    return result[0];
  }
  ...
  {
    return self_type(VOP(vfmax, vv, f64, LMUL, )(m_value, a.m_value, vl));
  }
  ...
  {
    auto e_ = VOP(vfmv, v_f, f64, 1,)(INFINITY, 1);
    auto vmin = VOP(vfredmin, vs, f64, LMUL, _f64m1)(m_value, e_, vl);
    element_type result[1];
    VOP(vse64, v, f64, 1, )(result, vmin, vl);
    return result[0];
  }
  ...
  {
    auto e_ = VOP(vfmv, v_f, f64, 1,)(INFINITY, 1);
    auto vmin_n = VOP(vfredmin, vs, f64, LMUL, _f64m1_m)(createMask(N), m_value, e_, vl);
    element_type result[1];
    VOP(vse64, v, f64, 1, )(result, vmin_n, vl);
    return result[0];
  }
  ...
  {
    return self_type(VOP(vfmin, vv, f64, LMUL, )(m_value, a.m_value, vl));
  }
// 
};
