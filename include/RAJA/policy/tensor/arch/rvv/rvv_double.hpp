...
typedef VTYPE(float64, __LMUL__) fixed_float64_t __attribute__((riscv_rvv_vector_bits(__LMUL__ * __VL__)));
...
public:
  ...
  Register(){
    vl = VSET(64, __LMUL__)();
    m_value = VOP(vfmv, v_f, f64, __LMUL__,)((double)0, vl);
  }
  ...
  Register(element_type const& c) : vl(VSET(64, __LMUL__)()){
    m_value = VOP(vfmv, v_f, f64, __LMUL__,)((double)c, vl);
  }
...
#endif
    m_value = VOP(vle64, v, f64, __LMUL__,)(ptr,  vl);
    return *this;
  }
...
#endif
    m_value = VOP(vle64, v, f64, __LMUL__,_m)(createMask(N), ptr, vl);
    return *this;
  }
...
#endif
    m_value = VOP(vlse64, v, f64, __LMUL__,)(ptr, stride * sizeof(element_type), vl);
    return *this;
  }
                            ...
                            camp::idx_t N)
  {
    ...
    m_value = VOP(vlse64, v, f64, __LMUL__ ,_m)(createMask(N), ptr, byte_stride, vl);
    return *this;
  }
  ...
  self_type& gather(element_type const* ptr, int_vector_type offsets)
  {
    ...
    m_value = VOP(vluxei64, v, f64, __LMUL__, )(ptr, index, vl);
    return *this;
  }
...
#endif 
    auto index = VREINTERPRET(i64, u64, __LMUL__)(offsets.get_register());
    m_value = VOP(vluxei64, v, f64, __LMUL__, _m)(createMask(N), ptr, index, vl);
    return *this;
  }
...
#endif
    VOP(vse64, v, f64, __LMUL__,)(ptr, m_value, vl);
    return *this;
  }
...
#endif
    VOP(vse64, v, f64, __LMUL__, _m)(createMask(N), ptr, m_value, vl);
    return *this;
  }
...
#endif
    VOP(vsse64, v, f64, __LMUL__,)(ptr, stride * sizeof(element_type), m_value, vl);
    return *this;
  }
...
#endif
    VOP(vsse64, v, f64, __LMUL__, _m)(createMask(N), ptr, stride * sizeof(element_type), m_value, vl);
    return *this;
  }
  ...
  { 
    ...
    VOP(vse64, v, f64, __LMUL__,)(temp, m_value, vl);
    return temp[i];
  }
  ...
  {
    element_type tmp[vl];
    VOP(vse64, v, f64, __LMUL__,)(tmp, m_value, vl);
    tmp[i] = value;
    m_value = VOP(vle64, v, f64, __LMUL__, )(tmp, vl);
    return *this;
  }
  ...
  {
    m_value = VOP(vfmv, v_f, f64, __LMUL__, )(value, vl);
    return *this;
  }
  ...
  self_type get_and_broadcast(int i) const
  {
    ...
    self_type result;
    result.m_value = VOP(vfmv, v_f, f64, __LMUL__, )(elem, vl);
    return result;
  }
  ...
  {
    return self_type(VOP(vfadd, vv, f64, __LMUL__,)(m_value, b.m_value, vl));
  }
  ...
  {
    return self_type(VOP(vfsub, vv, f64, __LMUL__,)(m_value, b.m_value, vl));
  }
  ...
  {
    return self_type(VOP(vfmul, vv, f64, __LMUL__,)(m_value, b.m_value, vl));
  }
  ...
  {
    return self_type(VOP(vfdiv, vv, f64, __LMUL__,)(m_value, b.m_value, vl));
  }
  ...
  {
    return self_type(VOP(vfdiv, vv, f64, __LMUL__, _m)(createMask(N), m_value, b.m_value, vl));
  }
...
// // only use FMA's if the compiler has them turned on
  ...
  {
    return self_type(VOP(vfmadd, vv, f64, __LMUL__,)(c.m_value, m_value, b.m_value, vl));
  }
  ...
  {
    return self_type(VOP(vfmsub, vv, f64, __LMUL__,)(c.m_value, m_value, b.m_value, vl));
  }
#endif
  ...
  element_type sum(camp::idx_t N = __LMUL__ * 4) const
  {
    ...
    auto vsum = VOP(vfredosum, vs, f64, __LMUL__,_f64m1_m)(createMask(N), m_value, init_scale, vl); 
  ...
  element_type max(camp::idx_t N = __LMUL__ * 4) const
  {
    ...
    auto vmax = VOP(vfredmax, vs, f64, __LMUL__, _f64m1_m)(createMask(N), m_value, e_, vl);
    element_type result[1];
  ...
  {
    return self_type(VOP(vfmax, vv, f64, __LMUL__, )(m_value, a.m_value, vl));
  }
  ...
  {
    auto e_ = VOP(vfmv, v_f, f64, 1,)(INFINITY, 1);
    auto vmin = VOP(vfredmin, vs, f64, __LMUL__, _f64m1)(m_value, e_, vl);
    element_type result[1];
  ...
  {
    auto e_ = VOP(vfmv, v_f, f64, 1,)(INFINITY, 1);
    auto vmin_n = VOP(vfredmin, vs, f64, __LMUL__, _f64m1_m)(createMask(N), m_value, e_, vl);
    element_type result[1];
  ...
  {
    return self_type(VOP(vfmin, vv, f64, __LMUL__, )(m_value, a.m_value, vl));
  }
// 
};
